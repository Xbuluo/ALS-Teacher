from configs.dota.oriented_rcnn import teacher_detector, student_detector
from configs.dota.oriented_rcnn import angle_version
from configs._base_.datasets.dotav15 import img_norm_cfg, dataset_type
