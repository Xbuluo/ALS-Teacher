...
def create_empty_anno(src_dir, out_dir):
    ...
    for file_ in files:
        file_name = file_.split('/')[-1].split('\\')[-1]
...
if __name__ == '__main__':
    root_path = "path_to_your_dota_dataset"  # Replace with your DOTA dataset root path
    src_dir = os.path.join(root_path, 'annfiles')
    out_dir = os.path.join(root_path, 'empty_annfiles')
